    ...
    <footer className="bg-dark-100 border-t border-white/10">
      <div className="container-main py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-heading font-semibold mb-4">公司</h3>
            <ul className="space-y-2">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-heading font-semibold mb-4">法律</h3>
            <ul className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Pump-Up. All rights reserved.
          </p>
